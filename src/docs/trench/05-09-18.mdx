...
title: 05/09/2018 - Second journal added
description: Second typed journal added describing Clancy's feelings towards Dema and the idea of "Home".
keywords:
  - wiki
  - second journal
  - clancy
...
- The MOON date (July 7th, 2017) marks the official first day of the band's hiatus between the albums Blurryface and Trench. On the previous day (July 6th), a sequence of tweets were posted by the official band account on Twitter/X featuring a red eye gradually closing. The [final tweet](https://twitter.com/twentyonepilots/status/883144349449682944) of this sequence would be followed by a year-long break with no social media activity from the band.
