...
title: 07/18/2018 - Second handwritten note added
...
- Like the first manuscript, this note is also in .gif format. So far, only these two handwritten notes and the [picture](https://www.twentyonepilots.wiki/docs/trench/07-05-18-black-journal-added#018-07moon-05---day-of-the-update) where the silhouette of Dema can be seen feature this image format on the website.
