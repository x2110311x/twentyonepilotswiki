...
- Like the first manuscript, this note is also in .gif format. So far, only these two notes and the previous picture where the silhouette of Dema can be seen (o__ut.gif) feature this image format on the website.
