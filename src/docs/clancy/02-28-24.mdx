...
- The relevance of this journal's date (February 25, 2024) is yet unclear.
...
- The letter originally appeared on the bottom of the website with the date "0001 11MOON 30", then later was updated to show on the top of the page with the correct day, "024 02MOON 09" (February 9th, 2024). The relevance of both dates is yet unclear.
- Analyzing the position of the doubled letters in each line from the left, we notice that they follow a 2-2-9 pattern - as in, the second letter in the 1st line is doubled, then the second in the 2nd line, then the ninth in the 3rd, etc. When converted into a date (2-29), the numbers hint to February 29th. This would be the release date of the single Overcompensate.
