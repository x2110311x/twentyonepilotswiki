...
- Two major differences between this map and the [black map](./scaledandicy/03-16-22.mdx) added previously to the website are a new location named "Paladin Strait" and Keons' tower in Dema now showing up as empty.
