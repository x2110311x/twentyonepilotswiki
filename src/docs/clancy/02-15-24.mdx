...
- Two major differences between this map and the [black map](https://www.twentyonepilots.wiki/docs/scaledandicy/03-16-22-dmaorg-unterminated-trench-map-added#022-03moon-16) added previously to the website are a new location named "Paladin Strait" and Keons' tower in Dema now showing up as empty.
...
- This letter would be later published on dmaorg.info in the next update.
