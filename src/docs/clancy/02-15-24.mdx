...
** Transcription of the main text printed on the document:**
...
- The handwritten message over the page, labeled as "evidence" by this document, says: "*How did you find http://dmaorg<span>.</span>info/found/15398642_14/clancy.html???*". This is the link to the main dmaorg website, which features Clancy's violation code and where all of his other journals have been published.
