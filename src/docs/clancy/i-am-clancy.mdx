...
On 22th of February, the band posted a video on Youtube. 

<iframe width="800" height="500" src="https://www.youtube.com/embed/ozlHHR_eSxc" title="I Am Clancy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

**Additional information:**
- In the background, a song from Ned's Cozy Fireplace is playing
- This video gives additional context to the Saturday music video where Trash crashes into the submarine where Tyler is playing a show, as well as The Outside music video where Keons gets stabbed by the other bishops. It is now confirmed that Keons betrayed Nico by seizing trash in an attempt to free Tyler from the submarine. 
- We also receive a confirmation that the Heavydirtysoul video features Tyler escaping *from* DEMA - first tricking Nico into taking him outside and then 'creating a diversion'. 
...
*"Diese kleine unheimliche Insel hat mich zu einer Waffe gemacht. Wir glauben beide-“*
 This is an exerpt from the [Clancy letter](./scaledandicy/03-18-22-2.mdx) from March 22nd 2022, and can also be heard in the beginning of the single Overcompensate that was released a week later.
