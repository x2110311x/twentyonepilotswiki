...
- Unlike the previous [grey map](./trench/original-dmaorg-files#013-01moon-08) that showcased the Sacred Municipality of Dema, this map's compass is already shifted to the correct orientation, with the East direction pointing up ("EAST IS UP").
