...
- The dragon on the album cover has lines in its body which precisely resemble the aerial view of Clancy Way - a street in Columbus, Ohio, where the music videos for Truce and Goner were filmed. Additionally, another set of lines form letters spelling the word "DESTROY".
