---
id: 04-05-21-account-terminated
...
- Trash's body contains a set of lines which precisely resemble the aerial view of [Clancy Way](https://www.google.com/maps/place/Clancy+Way,+Genoa+Township,+OH+43082,+EUA/@40.1588885,-82.9064053,17z) - a street in Columbus, Ohio, where the music videos for "Truce" and "Goner" were filmed. Additionally, another set of lines form letters spelling the word "DESTROY".
