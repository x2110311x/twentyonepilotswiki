...
title: 03/16/22 - Dmaorg Unterminated / Trench map added
...
At around 2:30PM Eastern Time, the main dmaorg.info page reverted back to its original state before the website termination started, as if nothing happened. A new MOON date was added along with an image of a black map.
...
- The date (March 16th 2022) is the date of this update. It also marks exactly 7 years since the start of the Blurryface era, prompted by the Fairly Local Music Video.
- “Voldsøy” roughly translates to “violence island” in Norwegian.
- A [tweet](https://twitter.com/tylerrjoseph/status/1504217893336231950) from Tyler, posted in the same day of the update, along with a previous [Instagram post](https://www.instagram.com/p/Ca52_GVu_lI) suggest that Voldsøy is the “small, frigid island” where Tyler and Josh washed up.
- The striped circular area displayed on the center of the map holds the same shape of the “Jumpsuit Medallion” symbol, discovered in the 2018 Bandito Immersive Experience by Spotify. It represents the valley of Trench.
