...
At around 2:45PM Eastern Time, the main dmaorg.info page reverted back to its original state before the website termination started, as if nothing ever happened to it. A new MOON date was added along with an image of a black map.
