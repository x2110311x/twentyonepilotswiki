...
- This picture is a halftoned, cropped version of a photo featuring Andre Weil (right, taken 31 December 1955) and a child covering the face, whose identity is yet unknown. Andre Weil was a famous mathematician who had introduced the use of “∅” to denote the empty set (used on the TØP official logo). He was also a member of a group called Nicolas Bourbaki.
